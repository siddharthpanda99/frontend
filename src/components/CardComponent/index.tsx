        ...
        <div className="cursor-pointer rounded-xl bg-white p-3 shadow-lg hover:shadow-xl">
          <div className="relative flex items-end overflow-hidden rounded-xl">
            ...
            <div className="absolute bottom-3 left-3 inline-flex items-center rounded-lg bg-white p-2 shadow-md">
              ...
              <span className="ml-1 text-sm text-slate-400">{info.rating}</span>
            </div>
          </div>

          <div className="mt-1 p-2">
            <h2 className="text-slate-700">{info.name}</h2>
            <p className="mt-1 text-sm text-slate-400">{info.location}</p>

            <div className="mt-3 flex items-end justify-between">
              <p>
                <span className="text-lg font-bold text-orange-500">Starting ${info.price}</span>
